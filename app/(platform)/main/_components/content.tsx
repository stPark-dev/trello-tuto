        ...
        <>
            <div className="flex flex-grow flex-col">
                <div data-v-08d12acd="">
                    <div
                        data-v-08d12acd=""
                        className="p-8 bg-white border-b border-b-gray-200"
                    >
                    ...
                    <div
                        data-v-08d12acd=""
                        className="dynamic-height overflow-scroll"
                    >
                        <div
                            data-v-08d12acd=""
                            role="list"
                        ...
                        >
                            <div
                                data-v-08d12acd=""
                                className="flex shrink-0 flex-col justify-between rounded-lg bg-white shadow sm:w-96 h-48 px-6 py-5 cursor-pointer"
                            >
                                <div className="flex flex-col gap-2">
                                    <div className="flex w-full items-center gap-2">
                                        ...
                                        <h3 className="text-lg font-medium text-black whitespace-normal line-clamp-2">
                                            TEST
                                        </h3>
                                    </div>
                                ...
                                <div className="flex w-full items-center justify-between">
                                    <div className="isolate flex -space-x-1 overflow-hidden p-0.5 pl-0.5">
                                        <div
                                            className="h-6 w-6 place-items-center ring-1 ring-brand-900/25 rounded-full relative inline-block"
                                            style={{ zIndex: 0 }}
                                        >
