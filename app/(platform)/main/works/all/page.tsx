...
const MainWorks = () => {
  ...
  return (
    <>
      <Box color="info" sx={{ display: "flex", flexDirection: "column", width: "100%", height: "100%", overflow: "auto" }}>
        <Box sx={{ px: 5, my: 5, display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
          ...
          >
            Create Works
            <VisuallyHiddenInput type="file" multiple onChange={handleFileChange} ref={fileInputRef} accept="image/*, .pdf" />
          </Button>
                    ...
                    <Grid item xs={12} sm={4} key={columnId}>
                      <Paper elevation={3} sx={{ minHeight: "100%", p: 2 }}>
                        <Box display="flex" alignItems="center">
                          ...
                          <IconButton onClick={() => addTaskToColumn(columnId, "New Task")} sx={{ ml: "auto" }}>
                                  ...
                                  <Draggable key={item.id} draggableId={item.id} index={index}>
                                    {(provided, snapshot) => (
                                      ...
                                      >
                                        ...
                                        <IconButton onClick={() => removeTaskFromColumn(columnId, item.id)} size="small" sx={{ ml: "auto" }}>
                                          <Delete />
                                        </IconButton>
                                      </Box>
                                    )}
