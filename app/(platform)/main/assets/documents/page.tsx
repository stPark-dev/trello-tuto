    ...
    const FileUploadComponent = () => (
        <Box sx={{
            ...
            sx={{
                ...
                <Typography>
                    <Typography component="span" sx={{ color: "primary.main", fontWeight: "medium" }}>Click to upload</Typography>
            ...
            <>
                ...
                >   <Box sx={{ display: "flex", flexDirection: "column" }}>
                        <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", p: 2, justifyContent: "space-between" }}>
                            <Box sx={{ display: "flex", flexDirection: "column" }}>
                                <Typography variant="body1" fontWeight="bold">Upload documents</Typography>
