    ...
    <>
      <Box sx={{ display: "flex", flexDirection: "column", width: "100%" }}>
        ...
        <Drawer anchor={"right"} open={drawerOpen} onClose={toggleDrawer(false)}>
          <Box sx={{ width: 450, height: "100vh", display: "flex", flexDirection: "column" }} role="space_detail">
            {selectedItem && (
              <>
                <Box
                  sx={{
                      ...
                      <OutlinedInput
                        ...
                        endAdornment={
                          <InputAdornment position="end">
                            <Tooltip title="Provide a category name.">
      ...
      >
        <DialogTitle id="icon-dialog-title">
          <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
            {"아이콘 선택"}
            <IconButton onClick={handleDiagClose} size="small">
              <Close />
            </IconButton>
          </Box>
        </DialogTitle>
        <DialogContent>
          <Box sx={{ display: "flex", flexDirection: "column", width: "100%", alignItems: "center" }}>
            <FormControl fullWidth size="small" sx={{ my: 2 }}>
              <Select labelId="demo-simple-select-label" id="demo-simple-select" value={selectedColor} onChange={handleColorChange} displayEmpty>
