...
const steps = [
  ...
  {
    label: "Location & Type",
    description: "Define the asset locatgion and type.",
  },
  {
    label: "Warranty & Info",
...
const AssetPage = ({ params }: { params: { buildingId: string } }) => {
  ...
  const SingleAssetDialog = () => {
    ...
    const renderTree = (nodes: GroupType[]): any =>
      nodes.map(node => {
            ...
            <TreeItem
              ...
              label={
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Checkbox checked={checked.includes(node.id)} onChange={event => handleToggle(event, node.id)} onClick={e => e.stopPropagation()} />
                  {node.name}
                </Box>
              }
            >
      ...
      <>
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold" }}>Create Asset</Box>
              <IconButton size="small" onClick={handleSingleAssetDiagClose}>
                <Close />
              </IconButton>
            </Box>
            <Divider />
            <Box sx={{ p: 3, display: "flex", flexDirection: "row" }}>
              ...
              <Box sx={{ flexGrow: 4 }}>
                {activeStep === 0 && (
                  <>
                    <Box sx={{ my: 2 }}>
                      ...
                      <Typography variant="body2" fontWeight="bold" sx={{ mb: 1, color: "#A6A6A6" }}>
                        Provide the name for the asset to be created.
                      </Typography>
                    ...
                    <Box sx={{ my: 2 }}>
                      ...
                      <Typography variant="body2" fontWeight="bold" sx={{ mb: 1, color: "#A6A6A6" }}>
                        Provide an optional identifier for this asset.
                      </Typography>
                      <FormControl sx={{ width: "100%" }} variant="outlined">
                        <OutlinedInput
                    ...
                    <Box sx={{ my: 2 }}>
                      ...
                      <Typography variant="body2" fontWeight="bold" sx={{ mb: 1, color: "#A6A6A6" }}>
                        Select an asset group for this asset.
                      </Typography>
                ...
                {activeStep === 1 && (
                  <>
                    <Box sx={{ my: 2 }}>
                      ...
                      <Typography variant="body2" fontWeight="bold" sx={{ mb: 1, color: "#A6A6A6" }}>
                        Select a location for this asset.
                      </Typography>
                      <FormControl fullWidth size="small">
                        <TextField
                          sx={{ mb: 2 }}
                ...
                {activeStep === 2 && (
                  <>
                    <Box sx={{ my: 2 }}>
                      ...
                      <Typography variant="body2" fontWeight="bold" sx={{ mb: 1, color: "#A6A6A6" }}>
                        Provide an optional brand for this asset.
                      </Typography>
                      <FormControl sx={{ width: "100%" }} variant="outlined">
                        <OutlinedInput
                    ...
                    <Box sx={{ my: 2 }}>
                      ...
                      <Typography variant="body2" fontWeight="bold" sx={{ mb: 1, color: "#A6A6A6" }}>
                        Provide an optional supplier for this asset.
                      </Typography>
                      <FormControl sx={{ width: "100%" }} variant="outlined">
                        <OutlinedInput
                    ...
                    <Box sx={{ my: 2 }}>
                      ...
                      <Typography variant="body2" fontWeight="bold" sx={{ mb: 1, color: "#A6A6A6" }}>
                        Provide an optional serial number for this asset.
                      </Typography>
                      <FormControl sx={{ width: "100%" }} variant="outlined">
                        <OutlinedInput
                ...
                <Box sx={{ display: "flex", justifyContent: activeStep === 0 ? "flex-end" : "space-between", mt: 2 }}>
                  {activeStep !== 0 && (
                    <Button type="button" variant="contained" color="secondary" disabled={!assetName} onClick={handleBackStep} startIcon={<ArrowBack />}>
                      Go back
                    </Button>
                  )}
                  <Button type="button" variant="contained" color="primary" disabled={!assetName} onClick={handleNextStep} endIcon={<ArrowForward />}>
                    Next step
                  </Button>
                </Box>
              </Box>
      ...
      <>
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold" }}>Create asset group</Box>
              <IconButton size="small" onClick={handleAssetGroupDiagClose}>
                <Close />
              </IconButton>
            </Box>
            <Divider />
            <Box sx={{ p: 2 }}>
              <Box sx={{ my: 2 }}>
                ...
                <Typography variant="body2" fontWeight="bold" sx={{ mb: 1, color: "#A6A6A6" }}>
                  Provide the name for the group.
                </Typography>
                <FormControl sx={{ width: "100%" }} variant="outlined">
                  <OutlinedInput
                    id="outlined-adornment-identifier"
    ...
    <>
      <Box sx={{ display: "flex", flexDirection: "column", width: "100%" }}>
        <Box sx={{ px: 5, mt: 5, display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: 1, borderColor: "grey.300" }}>
          ...
          >
            <MenuItem onClick={handleSingleAssetDiagOpen}>
              <Interests sx={{ mr: 1 }} />
              Single Asset
            </MenuItem>
            <MenuItem onClick={handleAssetGroupDiagOpen}>
              <FolderCopy sx={{ mr: 1 }} />
              Asset Group
            </MenuItem>
          </Menu>
              ...
              <List dense>
                <ListItem>
                  <ListItemButton sx={{ display: "flex", justifyContent: "space-between" }} onClick={() => setSelectedGroupId(null)}>
                    ...
                    <Box
                      sx={{ width: 25, height: 25, textAlign: "center", bgColor: theme.palette.mode === "dark" ? "#4D4D4D" : "#F2F4F7", borderRadius: "50%" }}
                    >
                      {data.length}
                    </Box>
                  </ListItemButton>
                ...
                <List dense>
                  {assetGroups.map(group => (
                    <ListItem key={group.id}>
                      <ListItemButton sx={{ display: "flex", justifyContent: "space-between" }} onClick={() => setSelectedGroupId(group.id)}>
                        <Box sx={{ display: "flex", alignItems: "center" }}>
                          <ListItemIcon sx={{ minWidth: 32 }}>
                            <FolderOutlined />
                          </ListItemIcon>
                      ...
                      <IconButton edge="end" size="small" onClick={event => handleGroupMenuClick(event, group.id)}>
                        <MoreVert />
                      </IconButton>
                      <Menu
                      ...
                      >
                        <MenuItem onClick={handleGroupMenuClose}>
                          <EditNote sx={{ mr: 1 }} />
                          Details
                        </MenuItem>
                        <MenuItem onClick={handleGroupMenuClose}>
