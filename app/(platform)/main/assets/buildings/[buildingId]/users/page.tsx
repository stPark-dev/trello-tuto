              ...
              <>
                    ...
                    <OutlinedInput
                      ...
                      endAdornment={
                        <InputAdornment position="end">
                          <Tooltip title="Provide an email address.">
                ...
                <Box sx={{ my: 2 }}>
                  ...
                  <Autocomplete
                    ...
                    renderInput={params => <TextField {...params} variant="outlined" label="Select roles" />}
                ...
                <Box sx={{ my: 2 }}>
                  ...
                  <FormControl sx={{ width: "100%" }} variant="outlined">
                    <OutlinedInput
                      ...
                      endAdornment={
                        <InputAdornment position="end">
                          <Tooltip title="Specify which function the user is going to have in this location">
                            <HelpOutline sx={{ cursor: "default" }} />
                          </Tooltip>
                        </InputAdornment>
                      }
