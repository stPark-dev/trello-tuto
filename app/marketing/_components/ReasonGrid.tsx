...
const ReasonGridComponent = () => {
  return (
    <Box id="sixCard" className={headingFont.className} sx={{ width: "80vw", margin: "auto", position: "relative" }}>
      <Box id="blur" aria-hidden="true" sx={{ pointerEvents: "none", position: "absolute", filter: "blur(50px)" }}>
        <Box
          sx={{
            position: "relative",
            left: "calc(50% - 5rem)",
