  ...
  const [cards, setCards] = useState<CardInterface[]>([
    {
      ...
      content:
        "Lorem ipsum dolor sit amet consectetur. Sem sagittis vitae laoreet blandit eget leo sit egestas orci. Sollicitudin elit non amet in condimentum quis luctus quis.",
      corp: "A 컴퍼니",
      name: "홍길동",
    },
    {
  ...
  return (
    <>
      <Box sx={{ width: "100vw", margin: "auto" }}>
        ...
        >
          <Typography variant="h3" sx={{ fontWeight: "bold", fontSize: { xs: "1.5rem", sm: "2.25rem", md: "3rem" } }}>
            이미 많은 기업들이
          </Typography>
          <Typography variant="h3" sx={{ fontWeight: "bold", fontSize: { xs: "1.5rem", sm: "2.25rem", md: "3rem" } }}>
            팀볼트와 함께하고 있습니다
        ...
        >
          <Typography variant="h5" sx={{ color: "text.secondary", fontSize: { xs: "1rem", sm: "1.25rem", md: "1.5rem" } }}>
            나의 자산을 효율적으로 관리하여 더 많은 가치를 창조 해보세요.
          </Typography>
        </Box>
