...
const CustomQrScanner: React.FC = () => {
  ...
  return (
    <Box>
      ...
      <Dialog open={Boolean(detectedUrl)} onClose={handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
        <DialogTitle id="alert-dialog-title">{"Open URL"}</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">{`QR 코드 감지: ${detectedUrl}. 감지된 URL로 이동하시겠습니까??`}</DialogContentText>
        </DialogContent>
        <DialogActions>
